...
export const photoSlots: Record<string, PhotoSlotDef> = {
  ...
  "hero-1": {
    ...
    aspect: "1/1",
    src: "/images/slots/hero-1.jpg?v=20260527-1",
    priority: 1,
    source: "owner-photo",
  },
  "hero-2": {
  ...
  "tool-balance-ball": {
    ...
    description: "낮은 플랫폼·스텝 위에서 자세를 유지하는 강아지 훈련 장면",
    alt: "강아지 밸런스 플랫폼 스텝 훈련",
    aspect: "1/1",
    src: "/images/slots/tool-balance-ball.jpg?v=20260515-3",
    priority: 1,
    source: "owner-photo",
  },
  "tool-cavaletti": {
    ...
    aspect: "1/1",
    src: "/images/slots/tool-cavaletti.jpg?v=20260515-3",
    priority: 1,
    source: "owner-photo",
  },
  "tool-fitpaws": {
    number: 7,
    section: "DogFitnessTools",
    description: "보라 디스크 또는 밸런스 팟 위에서 중심을 잡는 강아지 훈련 장면",
    alt: "강아지 밸런스 디스크 자세 유지 훈련",
    aspect: "1/1",
    src: "/images/slots/tool-fitpaws.jpg?v=20260515-3",
    priority: 1,
    source: "owner-photo",
  },
  "tool-proprioception": {
    number: 8,
    section: "DogFitnessTools",
    description: "낮은 패드·블록 위에서 발 감각과 정지 자세를 연습하는 장면",
    alt: "강아지 프로프리오셉션 패드 블록 균형 훈련",
    aspect: "1/1",
    src: "/images/slots/tool-proprioception.jpg?v=20260515-3",
    priority: 1,
    source: "owner-photo",
  },
  "tool-hurdle": {
    number: 9,
    section: "DogFitnessTools",
    description: "낮은 바와 매트 세팅 위에서 전지지 자세를 유지하는 훈련 장면",
    alt: "강아지 전지지 바 균형 훈련",
    aspect: "1/1",
    src: "/images/slots/tool-hurdle.jpg?v=20260515-3",
    priority: 1,
    source: "owner-photo",
  },
  "tool-routine": {
    number: 10,
    section: "DogFitnessTools",
    description: "램프와 매트 위에서 강아지가 균형 루틴을 수행하는 장면",
    alt: "강아지 램프 균형 루틴",
    aspect: "1/1",
    src: "/images/slots/tool-routine.jpg?v=20260515-3",
    priority: 2,
    source: "owner-photo",
  },
  ...
  "concern-obese-senior": {
    number: 24,
    section: "Concerns",
    description: "나이가 들었거나 움직임이 줄어든 강아지가 차분히 쉬고 있는 모습",
    alt: "운동 부족과 노령견 케어가 필요한 강아지",
    aspect: "1/1",
    src: "/images/slots/concern-obese-senior.jpg?v=20260515-3",
    priority: 2,
    source: "ai-generated",
  },
  "concern-leash": {
  ...
  "concern-confidence": {
    number: 26,
    section: "Concerns",
    description: "낯선 계단이나 높이 앞에서 머뭇거리는 강아지 모습",
    alt: "환경 자신감이 부족한 강아지",
    aspect: "1/1",
    src: "/images/slots/concern-confidence.jpg?v=20260515-3",
    priority: 2,
    source: "ai-generated",
  },
  "concern-handler": {
